        ...
        <div class="row mb-5">
            <div class="col-md-9 order-2">
                ...
                <div class="row mb-5">
                    ...
                    $data_group_produk = groupProduk($id_group, $halaman_awal, $batas);
                    ...
                    <?php foreach ($data_group_produk as $produk_hasil) { ?>
                        ...
                        <div class="col-sm-6 col-lg-4 mb-4 " data-aos="fade-up">
                            <div class="block-4 text-center border">
                                ...
                                <div class="block-4-text p-4 filter-men">
                    ...
                    <ul class="pagination justify-content-center">
                        <li class="page-item">
                            <a class="page-link" <?php if ($halaman > 1) {
                                                        echo "href='../isi/shop.php?id_group=$id_group&halaman=$previous'";
                                                    } ?>>Previous</a>
                        </li>
                        <?php
                        for ($x = 1; $x <= $total_halaman; $x++) {
                        ?>
                            <li class="page-item"><a class="page-link" href="../isi/shop.php?id_group=<?php echo $id_group; ?>&halaman=<?php echo $x ?>"><?php echo $x; ?></a></li>
                        <?php
                        }
                        ?>
                        <li class="page-item">
                            <a class="page-link" <?php if ($halaman < $total_halaman) {
                                                        echo "href='../isi/shop.php?id_group=$id_group&halaman=$next'";
                                                    } ?>>Next</a>
                        </li>
                    </ul>
                </nav>
